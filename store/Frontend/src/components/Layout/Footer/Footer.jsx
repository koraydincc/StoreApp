                ...
                <div className="footer-subscribe-wrapper">
                    <div className="footer-subscribe">
                        <div className="footer-subscribe-top">
                            ...
                            <p className="subscribe-desc">We'll email you a voucher worth $10 off your first order over
                                $50.</p>
                        </div>
            ...
            <div className="footer-widgets">
                <div className="brand-info">
                    <div className="footer-logo">
                         <a href="index.html" className="logo">Sports Store</a>
                    </div>
        ...
        <div className="container">
            <div className="footer-copyright">
                <div className="site-copyright">
                    <p>
                        Copyright 2023 © E-Commerce Theme. All right reserved. Powered by Koray Dinç.
                    </p>
                </div>
                <a href="#23">
                ...
                <div className="footer-menu">
                    <ul className="footer-menu-list">
                        <li className="list-item">
                            <a href="#323">Privacy Policy</a>
                        </li>
                        <li className="list-item">
                            <a href="#323">Terms and Conditions</a>
                        </li>
                        <li className="list-item">
                            <a href="#32">Returns Policy</a>
                        </li>
                    </ul>
                </div>
            </div>
